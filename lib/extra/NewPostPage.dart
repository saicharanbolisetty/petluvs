...
import 'package:petluvs/extra/sections.dart';
import 'package:petluvs/extra/widgets.dart';
...
class NewPostPage extends StatelessWidget {
  const NewPostPage({Key key,this.title}) : super(key: key);
  final String title;
  ...
  @override
  Widget build(BuildContext context) => const NewPostPageHome();
}


class NewPostPageHome extends StatefulWidget {
  const NewPostPageHome({ Key key }) : super(key: key);

  static const String routeName = '/newpostpage';

  @override
  _NewPostPageHomeState createState() => new _NewPostPageHomeState();
}

class _NewPostPageHomeState extends State<NewPostPageHome> {
